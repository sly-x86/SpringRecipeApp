...
public class RecipeServiceIT {
    ...
    public static final String NEW_DESCRIPTOR = "New Descriptor";
    ...
    public void testSaveOfDescription() {
        ...
        // when
        testRecipeCommand.setDescription(NEW_DESCRIPTOR);
        RecipeCommand savedRecipeCommand = recipeService.saveRecipeCommand(testRecipeCommand);

        // then
        assertEquals(NEW_DESCRIPTOR, savedRecipeCommand.getDescription());
